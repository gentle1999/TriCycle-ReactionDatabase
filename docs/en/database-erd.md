...
>
> Current schema: Alembic `0054_profile_refresh_dirty`. The ORM inventory contains
> 65 tables, 805 columns, 106 foreign keys, 78 UNIQUE constraints, 210 CHECK constraints,
> and 181 indexes. The full ERD is generated by NexusX `ErDiagram.from_sqlmodel(...)`.
