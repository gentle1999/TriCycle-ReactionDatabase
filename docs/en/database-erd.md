...
>
> Current schema: Alembic `0050_profile_source_visibility`. The ORM inventory contains
> 65 tables, 801 columns, 106 foreign keys, 78 UNIQUE constraints, 210 CHECK constraints,
> and 180 indexes. The full ERD is generated by NexusX `ErDiagram.from_sqlmodel(...)`.
